...
export function ReciboPagoModal({ isOpen, onClose, pago }: ReciboPagoModalProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-3xl p-0 overflow-hidden border-none shadow-2xl bg-slate-50">
                <DialogHeader className="p-6 bg-white border-b flex flex-row items-center justify-between space-y-0 print:hidden">
                ...
                <div className="p-8 bg-white m-4 rounded-2xl shadow-sm border border-slate-200 print:m-0 print:shadow-none print:border-none">
                    {/* Header Documento */}
                ...
                <div className="p-6 bg-slate-900 flex justify-between items-center print:hidden">
